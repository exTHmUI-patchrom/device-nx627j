...
#-----------------------------------------------------------------------------
vendor_saved_apps := Bluetooth BluetoothExt BluetoothMidiService BluetoothOpp ExtShared HTMLViewer KeyChain PacProcessor PrintRecommendationService PrintSpooler Stk WAPPushManager WallpaperBackup BackupRestoreConfirmation BlockedNumberProvider CarrierConfig DefaultContainerService EmergencyInfo ExternalStorageProvider FusedLocation InputDevices ManagedProvisioning MtpDocumentsProvider ProxyHandler SharedStorageBackup Shell StatementService StorageManager UserDictionaryProvider ZWallpaperCropper
...
#-----------------------------------------------------------------------------
vendor_modify_jars := com.qti.dpmframework framework-oahl-backward-compatibility framework oem-services qti-telephony-common services telephony-common wifi-service
