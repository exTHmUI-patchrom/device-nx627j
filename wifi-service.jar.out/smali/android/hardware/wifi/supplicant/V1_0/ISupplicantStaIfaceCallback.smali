...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
    ...
    instance-of v2, v1, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
    ...
    check-cast v0, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;

    return-object v0

    .line 18
    :cond_1
    new-instance v2, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    .local v2, "proxy":Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;->interfaceChain()Ljava/util/ArrayList;
...
.method public static getService()Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
    ...
    invoke-static {v0}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;->getService(Ljava/lang/String;)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
    .locals 1
    .param p0, "serviceName"    # Ljava/lang/String;
    .param p1, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public static getService(Z)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
    .locals 1
    .param p0, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v0, p0}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;->getService(Ljava/lang/String;Z)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIfaceCallback;
