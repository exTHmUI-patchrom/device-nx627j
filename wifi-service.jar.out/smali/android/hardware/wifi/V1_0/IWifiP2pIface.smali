...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/wifi/V1_0/IWifiP2pIface;
    ...
    instance-of v2, v1, Landroid/hardware/wifi/V1_0/IWifiP2pIface;
    ...
    .line 18
    :cond_1
    new-instance v2, Landroid/hardware/wifi/V1_0/IWifiP2pIface$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/wifi/V1_0/IWifiP2pIface$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    .local v2, "proxy":Landroid/hardware/wifi/V1_0/IWifiP2pIface;
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/wifi/V1_0/IWifiP2pIface;->interfaceChain()Ljava/util/ArrayList;
    ...
    const-string v5, "android.hardware.wifi@1.0::IWifiP2pIface"
...
.method public static getService()Landroid/hardware/wifi/V1_0/IWifiP2pIface;
    ...
    invoke-static {v0}, Landroid/hardware/wifi/V1_0/IWifiP2pIface;->getService(Ljava/lang/String;)Landroid/hardware/wifi/V1_0/IWifiP2pIface;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/wifi/V1_0/IWifiP2pIface;
    .locals 1
    .param p0, "serviceName"    # Ljava/lang/String;
    .param p1, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public static getService(Z)Landroid/hardware/wifi/V1_0/IWifiP2pIface;
    .locals 1
    .param p0, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v0, p0}, Landroid/hardware/wifi/V1_0/IWifiP2pIface;->getService(Ljava/lang/String;Z)Landroid/hardware/wifi/V1_0/IWifiP2pIface;
