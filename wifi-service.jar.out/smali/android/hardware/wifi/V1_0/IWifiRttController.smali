...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/wifi/V1_0/IWifiRttController;
    ...
    instance-of v2, v1, Landroid/hardware/wifi/V1_0/IWifiRttController;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/IWifiRttController;

    return-object v0

    .line 18
    :cond_1
    new-instance v2, Landroid/hardware/wifi/V1_0/IWifiRttController$Proxy;

    invoke-direct {v2, p0}, Landroid/hardware/wifi/V1_0/IWifiRttController$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    .local v2, "proxy":Landroid/hardware/wifi/V1_0/IWifiRttController;
    :try_start_0
    invoke-interface {v2}, Landroid/hardware/wifi/V1_0/IWifiRttController;->interfaceChain()Ljava/util/ArrayList;
...
.method public static getService()Landroid/hardware/wifi/V1_0/IWifiRttController;
    ...
    invoke-static {v0}, Landroid/hardware/wifi/V1_0/IWifiRttController;->getService(Ljava/lang/String;)Landroid/hardware/wifi/V1_0/IWifiRttController;
...
.method public static getService(Ljava/lang/String;Z)Landroid/hardware/wifi/V1_0/IWifiRttController;
    .locals 1
    .param p0, "serviceName"    # Ljava/lang/String;
    .param p1, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
...
.method public static getService(Z)Landroid/hardware/wifi/V1_0/IWifiRttController;
    .locals 1
    .param p0, "retry"    # Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {v0, p0}, Landroid/hardware/wifi/V1_0/IWifiRttController;->getService(Ljava/lang/String;Z)Landroid/hardware/wifi/V1_0/IWifiRttController;
