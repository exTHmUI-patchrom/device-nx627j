...
.method public addChannels(Landroid/net/wifi/WifiScanner$ScanSettings;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wifi/scanner/ChannelHelper$ChannelCollection;->addBand(I)V
...
.method public addChannels(Lcom/android/server/wifi/WifiNative$BucketSettings;)V
    ...
    .line 141
    iget v0, p1, Lcom/android/server/wifi/WifiNative$BucketSettings;->band:I
...
.method public getContainingChannelsFromSettings(Landroid/net/wifi/WifiScanner$ScanSettings;)Ljava/util/Set;
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wifi/scanner/ChannelHelper$ChannelCollection;->getContainingChannelsFromBand(I)Ljava/util/Set;
...
.method public getMissingChannelsFromSettings(Landroid/net/wifi/WifiScanner$ScanSettings;)Ljava/util/Set;
    ...
    .line 195
    .end local v0    # "missingChannels":Landroid/util/ArraySet;, "Landroid/util/ArraySet<Ljava/lang/Integer;>;"
    :cond_2
    iget v0, p1, Landroid/net/wifi/WifiScanner$ScanSettings;->band:I

    invoke-virtual {p0, v0}, Lcom/android/server/wifi/scanner/ChannelHelper$ChannelCollection;->getMissingChannelsFromBand(I)Ljava/util/Set;
...
.method public partiallyContainsSettings(Landroid/net/wifi/WifiScanner$ScanSettings;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/wifi/scanner/ChannelHelper$ChannelCollection;->partiallyContainsBand(I)Z
