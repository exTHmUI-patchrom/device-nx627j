...
.method private countActiveLines()I
    ...
    .local v4, "hasConnecting":Z
    .local v7, "hasRinging":Z
    :goto_0
    ...
    .line 777
    .local v8, "call":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v8, :cond_8
    ...
    iget-boolean v10, v8, Lcom/android/internal/telephony/test/CallInfo;->mIsMpty:Z

    if-eqz v10, :cond_1

    .line 779
    iget-object v10, v8, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    .line 784
    new-instance v6, Lcom/android/internal/telephony/test/InvalidStateEx;

    invoke-direct {v6}, Lcom/android/internal/telephony/test/InvalidStateEx;-><init>()V
    ...
    .line 774
    .end local v8    # "call":Lcom/android/internal/telephony/test/CallInfo;
    :cond_8
...
.method public conference()Z
    ...
    .line 614
    .local v3, "c":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v3, :cond_0
    ...
    .line 611
    .end local v3    # "c":Lcom/android/internal/telephony/test/CallInfo;
    :cond_0
    add-int/lit8 v0, v0, 0x1
    ...
    .line 625
    .local v1, "c":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v1, :cond_2
    ...
    iput-object v4, v1, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;

    .line 627
    if-lez v2, :cond_2

    .line 628
    iput-boolean v3, v1, Lcom/android/internal/telephony/test/CallInfo;->mIsMpty:Z

    .line 622
    .end local v1    # "c":Lcom/android/internal/telephony/test/CallInfo;
    :cond_2
...
.method public getClccLines()Ljava/util/List;
    ...
    .line 757
    .local v2, "c":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v2, :cond_0
    ...
    .line 754
    .end local v2    # "c":Lcom/android/internal/telephony/test/CallInfo;
    :cond_0
...
.method public getDriverCalls()Ljava/util/List;
    ...
    const-string v3, "SC< getDriverCalls "
...
.method public onAnswer()Z
    ...
    .line 363
    .local v2, "call":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v2, :cond_1
    ...
    .line 360
    .end local v2    # "call":Lcom/android/internal/telephony/test/CallInfo;
    :cond_1
    add-int/lit8 v1, v1, 0x1
...
.method public onDial(Ljava/lang/String;)Z
    ...
    .line 665
    iput-boolean v2, p0, Lcom/android/internal/telephony/test/SimulatedGsmCallState;->mNextDialFailImmediately:Z

    .line 667
    const-string v1, "GSM"

    const-string v3, "SC< dial fail (per request)"
    ...
    .line 673
    .local v1, "phNum":Ljava/lang/String;
    ...
    const-string v3, "SC< dial ignored (gprs)"
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/test/CallInfo;->isActiveOrHeld()Z
    ...
    iget-object v5, v5, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    iput-object v6, v5, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    invoke-static {v1}, Lcom/android/internal/telephony/test/CallInfo;->createOutgoingCall(Ljava/lang/String;)Lcom/android/internal/telephony/test/CallInfo;
    ...
    .line 721
    invoke-virtual {p0, v4, v0}, Lcom/android/internal/telephony/test/SimulatedGsmCallState;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 720
    invoke-virtual {p0, v0, v5, v6}, Lcom/android/internal/telephony/test/SimulatedGsmCallState;->sendMessageDelayed(Landroid/os/Message;J)Z
...
.method public progressConnectingCallState()V
    ...
    .line 224
    .local v1, "call":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v1, :cond_0
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/internal/telephony/test/SimulatedGsmCallState;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 221
    .end local v1    # "call":Lcom/android/internal/telephony/test/CallInfo;
    :cond_1
    add-int/lit8 v0, v0, 0x1
...
.method public releaseActiveAcceptHeldOrWaiting()Z
    ...
    .line 485
    .local v4, "c":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v4, :cond_0
    ...
    .line 482
    .end local v4    # "c":Lcom/android/internal/telephony/test/CallInfo;
    :cond_0
    add-int/lit8 v1, v1, 0x1
    ...
    .line 497
    .restart local v4    # "c":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v4, :cond_3

    iget-object v6, v4, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;

    sget-object v7, Lcom/android/internal/telephony/test/CallInfo$State;->DIALING:Lcom/android/internal/telephony/test/CallInfo$State;

    if-eq v6, v7, :cond_2

    iget-object v6, v4, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;

    sget-object v7, Lcom/android/internal/telephony/test/CallInfo$State;->ALERTING:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    iget-object v5, v4, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/test/CallInfo;->isRinging()Z
...
.method public releaseHeldOrUDUB()Z
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/test/CallInfo;->isRinging()Z
...
.method public separateCall(I)Z
    ...
    .line 585
    .local v6, "cb":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v6, :cond_1

    iget-object v7, v6, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    .line 592
    .end local v6    # "cb":Lcom/android/internal/telephony/test/CallInfo;
    :cond_1
    if-ne v4, v3, :cond_2
    ...
    iput-boolean v0, v6, Lcom/android/internal/telephony/test/CallInfo;->mIsMpty:Z
    :try_end_0
    .catch Lcom/android/internal/telephony/test/InvalidStateEx; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 600
    .local v1, "ex":Lcom/android/internal/telephony/test/InvalidStateEx;
    return v0
.end method
...
.method public triggerHangupForeground()Z
    ...
    .line 287
    .local v3, "call":Lcom/android/internal/telephony/test/CallInfo;
    if-eqz v3, :cond_1

    iget-object v5, v3, Lcom/android/internal/telephony/test/CallInfo;->mState:Lcom/android/internal/telephony/test/CallInfo$State;
    ...
    .line 284
    .end local v3    # "call":Lcom/android/internal/telephony/test/CallInfo;
    :cond_1
    add-int/lit8 v0, v0, 0x1
...
.method public triggerRing(Ljava/lang/String;)Z
    ...
    .line 187
    .local v4, "call":Lcom/android/internal/telephony/test/CallInfo;
    if-nez v4, :cond_0
    ...
    .line 184
    .end local v4    # "call":Lcom/android/internal/telephony/test/CallInfo;
    :cond_3
    :goto_1
    add-int/lit8 v0, v0, 0x1
    ...
    const-string v4, "triggerRing failed; all full"
    ...
    .line 206
    invoke-static {v2}, Lcom/android/internal/telephony/test/CallInfo;->createIncomingCall(Ljava/lang/String;)Lcom/android/internal/telephony/test/CallInfo;
