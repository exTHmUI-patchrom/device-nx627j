...
.field protected static final EVENT_GET_SMSC_DONE:I = 0x4c

.field private static final EVENT_ICC_CHANGED:I = 0x1e

.field protected static final EVENT_ICC_RECORD_EVENTS:I = 0x1d

.field protected static final EVENT_IMS_STATE_CHANGED:I = 0x50

.field protected static final EVENT_IMS_STATE_DONE:I = 0x51
...
.field protected static final EVENT_SET_SMSC_DONE:I = 0x4d
...
.field protected static final EVENT_VOICE_CALL_ENDED:I = 0x4f

.field protected static final EVENT_VOICE_CALL_STARTED:I = 0x4e
...
.field protected static final NUBIA_DUAL_VOLTE_ENABLE:Z
...
.field protected mEcbmHandler:Lcom/android/internal/telephony/EcbmHandler;
...
.method static constructor <clinit>()V
    ...
    .line 3859
    const-string v0, "ro.nubia.dual_volte.enable"
    ...
    :cond_0
    sput-boolean v1, Lcom/android/internal/telephony/Phone;->NUBIA_DUAL_VOLTE_ENABLE:Z
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZILcom/android/internal/telephony/TelephonyComponentFactory;)V
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/Phone;->mLooper:Landroid/os/Looper;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/Phone;->mActionDetached:Ljava/lang/String;
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/Phone;->mActionAttached:Ljava/lang/String;

    .line 496
    invoke-virtual {p7, p3}, Lcom/android/internal/telephony/TelephonyComponentFactory;->makeAppSmsManager(Landroid/content/Context;)Lcom/android/internal/telephony/AppSmsManager;

    move-result-object v3

    iput-object v3, p0, Lcom/android/internal/telephony/Phone;->mAppSmsManager:Lcom/android/internal/telephony/AppSmsManager;
    ...
    invoke-direct {v3, p0}, Lcom/android/internal/telephony/TelephonyTester;-><init>(Lcom/android/internal/telephony/Phone;)V

    iput-object v3, p0, Lcom/android/internal/telephony/Phone;->mTelephonyTester:Lcom/android/internal/telephony/TelephonyTester;
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/Phone;->mDnsCheckDisabled:Z
    ...
    invoke-interface {v0, p0, v4, v2}, Lcom/android/internal/telephony/CommandsInterface;->setOnCallRing(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/Phone;->mIsVoiceCapable:Z
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/Phone;->mDoesRilSendMultipleCallRing:Z
    ...
    iget-boolean v5, p0, Lcom/android/internal/telephony/Phone;->mDoesRilSendMultipleCallRing:Z
    ...
    iput v0, p0, Lcom/android/internal/telephony/Phone;->mCallRingDelay:I
    ...
    iget v5, p0, Lcom/android/internal/telephony/Phone;->mCallRingDelay:I
    ...
    invoke-virtual {v6, v4}, Landroid/net/wifi/WifiManager;->setCountryCode(Ljava/lang/String;)V
    ...
    .line 558
    iget-object v4, p0, Lcom/android/internal/telephony/Phone;->mTelephonyComponentFactory:Lcom/android/internal/telephony/TelephonyComponentFactory;

    invoke-virtual {v4, p0}, Lcom/android/internal/telephony/TelephonyComponentFactory;->makeSmsStorageMonitor(Lcom/android/internal/telephony/Phone;)Lcom/android/internal/telephony/SmsStorageMonitor;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/telephony/Phone;->mSmsStorageMonitor:Lcom/android/internal/telephony/SmsStorageMonitor;

    .line 559
    iget-object v4, p0, Lcom/android/internal/telephony/Phone;->mTelephonyComponentFactory:Lcom/android/internal/telephony/TelephonyComponentFactory;

    invoke-virtual {v4, p3}, Lcom/android/internal/telephony/TelephonyComponentFactory;->makeSmsUsageMonitor(Landroid/content/Context;)Lcom/android/internal/telephony/SmsUsageMonitor;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/telephony/Phone;->mSmsUsageMonitor:Lcom/android/internal/telephony/SmsUsageMonitor;
    ...
    iput-object v4, p0, Lcom/android/internal/telephony/Phone;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;

    .line 561
    iget-object v4, p0, Lcom/android/internal/telephony/Phone;->mUiccController:Lcom/android/internal/telephony/uicc/UiccController;

    const/16 v5, 0x1e

    invoke-virtual {v4, p0, v5, v2}, Lcom/android/internal/telephony/uicc/UiccController;->registerForIccChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 562
    iget-object v4, p0, Lcom/android/internal/telephony/Phone;->mTelephonyComponentFactory:Lcom/android/internal/telephony/TelephonyComponentFactory;

    invoke-virtual {v4, p0}, Lcom/android/internal/telephony/TelephonyComponentFactory;->makeSimActivationTracker(Lcom/android/internal/telephony/Phone;)Lcom/android/internal/telephony/SimActivationTracker;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/telephony/Phone;->mSimActivationTracker:Lcom/android/internal/telephony/SimActivationTracker;
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForSrvccStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->setOnUnsolOemHookRaw(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 568
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/Phone;->obtainMessage(I)Landroid/os/Message;

    move-result-object v5

    .line 567
    invoke-interface {v2, v4, v1, v5}, Lcom/android/internal/telephony/CommandsInterface;->startLceService(IZLandroid/os/Message;)V
...
.method private handleSrvccStateChanged([I)V
    ...
    .line 775
    invoke-virtual {p0}, Lcom/android/internal/telephony/Phone;->updateImsIcon()Z
...
.method private updateImsPhone()V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/android/internal/telephony/Phone;->mEcbmHandler:Lcom/android/internal/telephony/EcbmHandler;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/internal/telephony/EcbmHandler;->updateImsPhone(Lcom/android/internal/telephony/Phone;I)V
...
.method public getSmscAddress()Ljava/lang/String;
    ...
    .line 3846
    iget-object v0, p0, Lcom/android/internal/telephony/Phone;->mSmscAddress:Ljava/lang/String;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 739
    :cond_0
    iget-object v1, p0, Lcom/android/internal/telephony/Phone;->mAddressToSet:Ljava/lang/String;

    iput-object v1, p0, Lcom/android/internal/telephony/Phone;->mSmscAddress:Ljava/lang/String;
    ...
    .line 717
    .local v1, "statusInfo":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    const/4 v2, 0x0
    ...
    iput v2, p0, Lcom/android/internal/telephony/Phone;->mLceStatus:I

    .line 719
    .end local v1    # "statusInfo":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/Integer;>;"
    goto/16 :goto_2
    ...
    iput v2, p0, Lcom/android/internal/telephony/Phone;->mCallRingContinueToken:I
...
.method public sendSubscriptionSettings(Z)V
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/Phone;->restoreSavedNetworkSelection(Landroid/os/Message;)V
...
.method public setSmscAddress(Ljava/lang/String;)V
    ...
    .line 3849
    iput-object p1, p0, Lcom/android/internal/telephony/Phone;->mAddressToSet:Ljava/lang/String;
...
.method public updateImsIcon()Z
    ...
    .line 3871
    sget-boolean v7, Lcom/android/internal/telephony/Phone;->NUBIA_DUAL_VOLTE_ENABLE:Z

    if-eqz v7, :cond_0

    .line 3872
    iget-object v7, p0, Lcom/android/internal/telephony/Phone;->mContext:Landroid/content/Context;
    ...
    const-string v9, "ims_registered_"
    ...
    .line 3866
    .end local v6    # "isImsRegistered":Z
    :cond_3
    add-int/lit8 v0, v0, 0x1
    ...
    .end local v0    # "i":I
    :cond_4
    sget-boolean v0, Lcom/android/internal/telephony/Phone;->NUBIA_DUAL_VOLTE_ENABLE:Z
    ...
    const-string v6, "ims_registered"
