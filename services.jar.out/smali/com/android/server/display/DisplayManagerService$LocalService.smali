...
# instance fields
.field mScreenSwitchManager:Lnubia/os/screenswitch/ScreenSwitchManager;
...
.method public getDisplayInfo(I)Landroid/view/DisplayInfo;
    ...
    invoke-static {v0, p1, v1}, Lcom/android/server/display/DisplayManagerService;->access$2400(Lcom/android/server/display/DisplayManagerService;II)Landroid/view/DisplayInfo;
...
.method public getNonOverrideDisplayInfo(ILandroid/view/DisplayInfo;)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/display/DisplayManagerService;->access$6200(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
...
.method public getScreenBrightness()I
    ...
    invoke-virtual {v0}, Lcom/android/server/display/DisplayPowerController;->getScreenBrightness()I
...
.method public initPowerManagement(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;)V
    ...
    .line 2581
    invoke-static {v7, v8}, Lcom/android/server/display/DisplayManagerService;->access$4602(Lcom/android/server/display/DisplayManagerService;Lcom/android/server/display/DisplayPowerController;)Lcom/android/server/display/DisplayPowerController;
    ...
    invoke-static {v0}, Lcom/android/server/display/DisplayManagerService;->access$5800(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayManagerService$DisplayManagerHandler;
...
.method public isProximitySensorAvailable()Z
    ...
    invoke-static {v1}, Lcom/android/server/display/DisplayManagerService;->access$4600(Lcom/android/server/display/DisplayManagerService;)Lcom/android/server/display/DisplayPowerController;
...
.method public isUidPresentOnDisplay(II)Z
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/display/DisplayManagerService;->access$6600(Lcom/android/server/display/DisplayManagerService;II)Z
...
.method public registerDisplayTransactionListener(Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$5900(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
...
.method public setDisplayAccessUIDs(Landroid/util/SparseArray;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$6500(Lcom/android/server/display/DisplayManagerService;Landroid/util/SparseArray;)V
...
.method public setDisplayInfoOverrideFromWindowManager(ILandroid/view/DisplayInfo;)V
    ...
    invoke-static {v0, p1, p2}, Lcom/android/server/display/DisplayManagerService;->access$6100(Lcom/android/server/display/DisplayManagerService;ILandroid/view/DisplayInfo;)V
...
.method public setDisplayOffsets(III)V
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/android/server/display/DisplayManagerService;->access$6400(Lcom/android/server/display/DisplayManagerService;III)V
...
.method public setDisplayPowerMode(Z)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$6700(Lcom/android/server/display/DisplayManagerService;Z)V
...
.method public setDisplayProperties(IZFIZ)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/server/display/DisplayManagerService;->access$6300(Lcom/android/server/display/DisplayManagerService;IZFIZ)V
...
.method public setScreenBrightness(IZ)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/display/DisplayPowerController;->setScreenBrightness(IZ)V
...
.method public unregisterDisplayTransactionListener(Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
    ...
    invoke-static {v0, p1}, Lcom/android/server/display/DisplayManagerService;->access$6000(Lcom/android/server/display/DisplayManagerService;Landroid/hardware/display/DisplayManagerInternal$DisplayTransactionListener;)V
...
.method public updateDoubleScreenBrightness()V
    .locals 4
    ...
    .line 2730
    :cond_0
    iget-object v0, p0, Lcom/android/server/display/DisplayManagerService$LocalService;->mScreenSwitchManager:Lnubia/os/screenswitch/ScreenSwitchManager;
    ...
    iput-object v0, p0, Lcom/android/server/display/DisplayManagerService$LocalService;->mScreenSwitchManager:Lnubia/os/screenswitch/ScreenSwitchManager;
    ...
    const-string/jumbo v3, "updateDoubleScreenBrightness 1 "
    ...
    invoke-static {v3}, Lcom/android/server/display/DisplayManagerService;->access$1500(Lcom/android/server/display/DisplayManagerService;)I
    ...
    invoke-static {v2}, Lcom/android/server/display/DisplayManagerService;->access$1500(Lcom/android/server/display/DisplayManagerService;)I

    move-result v2

    add-int/lit16 v2, v2, 0x1000

    invoke-virtual {v1, v2}, Lcom/android/server/display/DisplayPowerController;->setTemporaryBrightness(I)V
